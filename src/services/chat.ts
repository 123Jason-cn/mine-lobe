...
class ChatService {
  createAssistantMessage = async (
    ...
    console.log('createAssistantMessage ', messages)
  ...
  getChatCompletion = async (params: Partial<ChatStreamPayload>, options?: FetchOptions) => {
    ...
    console.log('getChatCompletion ', params)
      ...
      imageList.map(async (image) => {
        ...
        if (isVideo) {
          return {
            ...
            pathUrl: isVideo ? image.pathUrl : undefined,

            fileData: {
              mimeType: image.fileType,
              fileUri: image.pathUrl
            }
          } as const;
        } else {
          return {
  ...
  private fetchOnClient = async (params: {
    ...
    console.log('fetchOnClient ', params)
    /**
